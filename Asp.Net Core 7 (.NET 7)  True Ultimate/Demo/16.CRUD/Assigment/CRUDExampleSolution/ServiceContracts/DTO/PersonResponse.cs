...
namespace ServiceContracts.DTO
{
    ...
    public class PersonResponse
    {
        ...
        /// <summary>
        /// Compares current data with param object
        /// </summary>
        /// <param name="obj">the param person response object to compare</param>
        ...
        public override bool Equals(object? obj)
        {
            ...
            return PersonID == person.PersonID && PersonName == person.PersonName && Email == person.Email &&
                   ...
                   Address == person.Address && ReciveNewsLetters == person.ReciveNewsLetters;    
        }
        ...
        public PersonUpdateRequest ToPersonUpdateRequest()
        {
            return new PersonUpdateRequest()
            {
                ...
                CountryID = CountryID, ReciveNewsLetters = ReciveNewsLetters
            };
        }
    }
