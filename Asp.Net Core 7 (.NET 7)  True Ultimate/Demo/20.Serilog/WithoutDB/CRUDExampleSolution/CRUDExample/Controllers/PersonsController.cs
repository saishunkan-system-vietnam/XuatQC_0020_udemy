...
namespace CRUDExample.Controllers
{
    ...
    public class PersonsController : Controller
    {
        ...
        public PersonsController(IPersonService personService, ICountriesService countriesService,
            IFinnhubService finnhubService, IStocksService stocksService, ILogger<PersonsController> logger)
        {
            ...
            string sortBy = nameof(PersonResponse.PersonName), SortedOrderOptions sortOrder = SortedOrderOptions.ASC)
        {
            ...
            _logger.LogDebug("Person: {searchBy}, searchValue: {searchValue}", searchBy, searchValue);
        ...
        public IActionResult Create(PersonAddRequest personAddRequest)
        {
            ...
            _logger.LogDebug("personAddRequest: {personAddRequest}", personAddRequest);
