...
namespace Services
{
    public class PersonService : IPersonService
    {
        ...
        public PersonService(ICountriesService countriesService, ILogger<PersonService> logger, bool initialize = true)
        {
            _logger = logger;
        ...
        public PersonResponse? GetPersonById(Guid? personId)
        {
            ...
            _logger.LogDebug("GetPersonById personId {personId} ", personId);
