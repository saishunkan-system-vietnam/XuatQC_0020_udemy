...
namespace TestFinnhub.Controllers
{
    ...
    public class TradeController : Controller
    {
        ...
        public TradeController(IFinnhubService finnhubService, IOptions<TradingOptions> tradingOptions, IStocksService stocksService, IConfiguration configuration)
        {
